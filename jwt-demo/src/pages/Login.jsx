...
import { LockKeyhole, User as UserIcon, Loader2 } from 'lucide-react'; // Icons for better UX
...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Replace simple alert with a smoother UX later if possible
            navigate("/dashboard");
        } catch (error) {
            console.error(error);
        ...
        <div className='min-h-screen w-full bg-[#0a0a0a] flex items-center justify-center p-6 relative overflow-hidden'>
            ...
            <div className='w-full max-w-md z-10'>
                ...
                <form 
                    ...
                    className='flex flex-col gap-5 bg-white/5 p-8 rounded-[2rem] backdrop-blur-2xl border border-white/10 shadow-2xl'
                >
                    <div className="space-y-4">
                        <div className="relative">
                            <label className="text-xs font-semibold text-slate-400 uppercase tracking-wider ml-1 mb-1 block">
                                Username
                            </label>
